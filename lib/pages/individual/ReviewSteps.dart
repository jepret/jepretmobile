  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Container(
        ...
        child: Column(
          children: <Widget>[
            _renderStep1(context),
            _renderStep2(context),
            _renderStep3(context),
            _renderStep4(context),
          ],
        ),
      ),
    );
...
Widget _renderStep1(BuildContext context) {
  Widget content;
...
Widget _renderStep2(BuildContext context) {
  Widget content;
...
Widget _renderStep3(BuildContext context) {
  Widget content;
...
Widget _renderStep4(BuildContext context) {
  Widget content;
